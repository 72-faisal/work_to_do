...
<style>
.overlay {
  border: 2px solid black; /* Set the border style to a 1px solid black line */
  padding: 10px;
  margin-top: 10px; /* Add some padding around the box content to make it easier to read */
}
		...
		<div class="header_agileinfo">
						<div class="w3_agileits_header_text">
								<ul class="top_agile_w3l_info_icons">
									<li><i class="fa fa-home" aria-hidden="true"></i>Near Kankariya,Ahemdabad</li>
									<li class="second"><i class="fa fa-phone" aria-hidden="true"></i>(+91)8200405262</li>
									
									<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:maria@example.com">khajinadoc@gmail.com</a></li>
								</ul>

						</div>
						<div class="agileinfo_social_icons">
							<ul class="agileits_social_list">
								<li><a href="72__faisal" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<li><a href="72__faisal" class="agile_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
								<li><a href="72__faisal" class="w3_agile_dribble"><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
								<li><a href="72__faisal" class="w3_agile_rss"><i class="fa fa-rss" aria-hidden="true"></i></a></li>
							</ul>
						</div>
...
<div class="department-box">
            ...
            <img src="images/g1.jpg" alt=" " class="img-responsive" />
                ...
                <h4>Cardiology</h4><br>
                 <div class="btn-group" role="group">
                    <button type="button" class="btn btn-primary">View Department</button>
    ...
    <div class="row">
		...
		<div class="container">
		<h3 class="w3_heade_tittle_agile">About Our Departments</h3>
