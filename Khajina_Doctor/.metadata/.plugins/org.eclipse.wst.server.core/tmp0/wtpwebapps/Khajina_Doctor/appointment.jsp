		...
		<div class="container">
					...
					<div class="book-appointment">
						<h4>Make an appointment</h4>
								...
								<div class="gaps">
									<p>Patient Name</p>
										<input type="text" name="Appointment_name" placeholder="" required=""/>
								</div>	
									<div class="gaps">	
									<p>Phone Number</p>
										<input type="text" name="Appointment_number" placeholder="" required=""/>
									</div>
									<div class="gaps">
									<p>Email</p>
											<input type="email" name="Appointment_email" placeholder="" required="" />
									</div>	
									<div class="gaps">
									<p>Symptoms</p>
											<textarea name="Appointment_symptoms" placeholder="" required="" ></textarea>
									</div>
								</div>
